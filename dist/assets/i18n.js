...
const I18N = {
    ...
    dict: {
        ...
        'card.aim.title':      { es: 'Aim Room', en: 'Aim Room' },
        'card.aim.desc':       { es: 'Práctica gratuita de aim para shooters y MOBAs: flicking, objetivos móviles y control preciso del cursor.', en: 'Free aim practice for shooters and MOBAs: flicking, moving targets and precise cursor control.' },
        'card.aim.tag':        { es: 'Práctica de aim', en: 'Aim Practice' },
        'card.aim.aria':       { es: 'Aim Room — práctica gratuita de aim para shooters y MOBAs', en: 'Aim Room — free aim practice for shooters and MOBAs' },
        ...
        // ── aim ──
        'aim.sub':         { es: 'Práctica gratuita de aim para shooters y MOBAs · precisión, flicking y control del cursor',
                             en: 'Free aim practice for shooters and MOBAs · precision, flicking and cursor control' },
        'aim.guide.open':  { es: 'Sobre Aim Room y preguntas frecuentes', en: 'About Aim Room & FAQ' },
        'aim.guide.close': { es: 'Cerrar la guía de Aim Room', en: 'Close Aim Room guide' },
        'aim.seo.eyebrow': { es: 'Buffmechanics Aim Room', en: 'Buffmechanics Aim Room' },
        'aim.seo.title':   { es: 'Práctica gratuita de aim para shooters y MOBAs', en: 'Free aim practice for shooters and MOBAs' },
        'aim.seo.intro':   { es: 'Aim Room es un entrenador de aim gratuito para navegador enfocado en adquirir objetivos rápidamente, seguir blancos móviles y controlar el cursor con precisión. Comienza con Shooter o MOBA, desafía Supervivencia o guarda un ejercicio personalizado.', en: 'Aim Room is a free browser aim trainer for quick target acquisition, moving targets and precise cursor control. Start with Shooter or MOBA, challenge Survival, or save a custom drill.' },
        'aim.faq.title':   { es: 'Preguntas sobre la práctica de aim', en: 'Aim practice FAQ' },
        'aim.faq.q1':      { es: '¿Aim Room es un entrenador de aim online gratuito?', en: 'Is Aim Room a free online aim trainer?' },
        'aim.faq.a1':      { es: 'Sí. Aim Room funciona en un navegador moderno, no requiere instalación y guarda tu historial de práctica localmente en este dispositivo.', en: 'Yes. Aim Room runs in a modern browser with no installation and stores your practice history locally on this device.' },
        'aim.faq.q2':      { es: '¿Qué entrena la práctica de aim?', en: 'What does aim practice train?' },
        'aim.faq.a2':      { es: 'Aísla la adquisición de objetivos, los flicks, los microajustes y el control del cursor. Aim Room mide aciertos por segundo, precisión y mejor racha para comparar sesiones equivalentes.', en: 'It isolates target acquisition, flicking, micro-adjustments and cursor control. Aim Room measures hits per second, accuracy and your best streak so you can compare equivalent sessions.' },
        'aim.faq.q3':      { es: '¿Aim Room sirve para shooters o MOBAs?', en: 'Is Aim Room for shooters or MOBAs?' },
        'aim.faq.a3':      { es: 'Para ambos. Shooter enfatiza apariciones aleatorias, entradas laterales y objetivos cerca del cursor. MOBA prioriza líneas móviles, rebotes y objetivos cercanos similares al posicionamiento para skillshots.', en: 'Both. Shooter emphasizes random appearances, side entries and targets near the cursor. MOBA emphasizes moving lines, rebounds and nearby targets that resemble cursor placement for skillshots.' },
        'aim.faq.q4':      { es: '¿Qué perfil de práctica de aim debería elegir?', en: 'Which aim practice profile should I choose?' },
        'aim.faq.a4':      { es: 'Elige Shooter para flicks rápidos y microajustes, MOBA para trayectorias móviles o Personalizado para guardar tu duración, tamaño de objetivo, patrones y ritmo preferidos.', en: 'Choose Shooter for fast flicks and micro-adjustments, MOBA for moving trajectories, or Custom to save your preferred duration, target size, patterns and pace.' },
        'aim.faq.q5':      { es: '¿Cómo funciona el modo Supervivencia?', en: 'How does Survival mode work?' },
        'aim.faq.a5':      { es: 'Comienzas con tres vidas. Un clic fallido o un objetivo expirado quita una vida, y el intervalo base se acelera 100 milisegundos cada diez aciertos hasta llegar a 300 milisegundos.', en: 'You begin with three lives. A missed click or expired target removes one life, and the base interval becomes 100 milliseconds faster every ten hits until it reaches 300 milliseconds.' },
        'aim.faq.q6':      { es: '¿Qué hace el modo Progresivo?', en: 'What does Progressive mode do?' },
        'aim.faq.a6':      { es: 'Progresivo reduce 50 milisegundos el intervalo base cada diez aciertos hasta llegar a 200 milisegundos. La barra inferior cuenta cada ciclo y señala cada aumento real de velocidad.', en: 'Progressive mode reduces the base spawn interval by 50 milliseconds every ten hits until 200 milliseconds. The lower bar counts each cycle and signals every real speed increase.' },
        'aim.faq.q7':      { es: '¿Cuánto tiempo debería practicar aim?', en: 'How long should I practice aim?' },
        'aim.faq.a7':      { es: 'Comienza con una sesión breve que puedas repetir con constancia. Compara intentos con la misma duración y configuración, y detente cuando la fatiga comience a reducir tu control.', en: 'Start with a short session you can repeat consistently. Compare attempts with the same duration and configuration, and stop when fatigue begins to reduce your control.' },
        'aim.faq.q8':      { es: '¿La práctica de aim en el navegador replica exactamente un juego?', en: 'Does browser aim practice match a game exactly?' },
        'aim.faq.a8':      { es: 'Ningún navegador puede reproducir completamente la entrada directa, el campo de visión o las físicas de objetivos de cada juego. Usa Aim Room para practicar un control consistente del cursor y comparar resultados con la misma configuración.', en: "No browser can reproduce every game's raw input, field of view or target physics. Use Aim Room to practice consistent cursor control and compare results within the same setup." },
